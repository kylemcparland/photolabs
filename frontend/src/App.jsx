...
const App = () => {
  ...
  return (
    <div className="App">
      ...
      <HomeRoute updateToFavPhotoIds={updateToFavPhotoIds} topics={state.topicData} photos={state.photoData} setPhotoSelected={setPhotoSelected} favPhotoArray={state.favPhotoArray} />
    </div>
  );
};
